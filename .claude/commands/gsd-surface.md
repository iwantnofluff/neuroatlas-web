...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/.gsd-surface.json`
(sibling to `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/skills`).
...
`/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/.gsd-surface.json`
Install profile marker: `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/.gsd-profile`
Skill dirs: `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/skills/gsd-*/`
Engine module: `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
