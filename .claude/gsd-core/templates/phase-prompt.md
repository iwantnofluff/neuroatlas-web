...
<!-- For checkpoint task examples and patterns, see @/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/templates/user-setup.md` for full schema and examples
