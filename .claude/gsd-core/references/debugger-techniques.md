...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude
                  → checks /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core
                  → writes to /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/hooks/
