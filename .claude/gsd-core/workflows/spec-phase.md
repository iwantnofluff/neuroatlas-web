...
ones). Reference: @/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/templates/spec.md.
