...
<required_reading>
@/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/ai-frameworks.md
@/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-eval-planner.md for instructions.
