...
```
Agent(
  prompt="Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/templates/VALIDATION.md`
