...
```markdown
Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/agents/gsd-ui-checker.md for instructions.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
