...
- **Global scope**: `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/notes/`)
...
2. Glob `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/notes/` — works in any directory
