...
**Verification depth scales with `asvs_level`** (full definitions: @/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/security-asvs-levels.md):
