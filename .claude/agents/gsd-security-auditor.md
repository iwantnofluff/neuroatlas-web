...
**Verification depth scales with `asvs_level`** (see @/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
