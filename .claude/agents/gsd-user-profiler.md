...
Read the user-profiling reference document at `/Users/Jonathan/Downloads/NoFulff/NeuroAtlas/neuroatlas-web/.claude/gsd-core/references/user-profiling.md` to load:
